...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-green-500 flex items-center justify-center shadow-lg hover:scale-110 hover:shadow-2xl transition-all duration-300 group"
