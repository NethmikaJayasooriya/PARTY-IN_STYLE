...
const SERVICES = [
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=900&auto=format&fit=crop&q=80",
  },
  {
    icon: "nightlife",
    ...
    img: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=900&auto=format&fit=crop&q=80",
  },
];
    ...
    <>
      ...
      <section className="relative py-stack-md overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=1600&auto=format&fit=crop&q=80" alt="" className="w-full h-full object-cover opacity-15" />
        ...
        <div className="relative z-10 max-w-container-max mx-auto px-6 md:px-margin-x text-center">
          ...
          <h1 className="font-display-xl text-5xl md:text-7xl text-on-surface mb-4">
            What We <span className="gradient-text italic">Do</span>
          </h1>
          ...
          <p className="font-body-lg text-base text-on-surface-variant font-light max-w-2xl mx-auto">
            Meticulously crafted experiences, designed with precision and executed with flawless grace.
          </p>
        </div>
      </section>
              ...
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center ${i % 2 === 1 ? "lg:direction-rtl" : ""}`}>
                ...
                <div className={i % 2 === 1 ? "lg:order-1" : ""}>
                  ...
                  <div className="flex flex-wrap gap-3 mb-8">
                    {s.features.map((f) => (
                      <span key={f} className="glass-panel px-4 py-2 rounded-full text-xs text-on-surface-variant uppercase tracking-wider font-label-sm">
                        {f}
                      </span>
                    ))}
                  </div>
                  <Link href="/contact" className="inline-flex items-center gap-2 bg-primary text-on-primary-container font-label-sm text-xs font-semibold px-8 py-3 rounded-sm uppercase tracking-[0.15em] metallic-sheen hover:bg-primary-light transition-colors">
      ...
      <RevealSection>
        <section className="py-stack-md max-w-container-max mx-auto px-6 md:px-margin-x text-center">
          ...
          <p className="font-body-lg text-base text-on-surface-variant font-light mb-8 max-w-xl mx-auto">
            We specialise in one-of-a-kind events. Tell us your vision and we&#39;ll make it happen.
          </p>
